...
services:
	...
	$(CC) $(CFLAGS) -c -Iincludes -o build/permission.o src/permission.c
	...
	$(CC) $(BINFLAGS) -o acuity build/acuity.o build/panic.o build/config.o build/permission.o build/db.o build/module.o build/service.o build/events.o build/util.o build/encrypt.o $(LIBS)
